...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="{{ route('getAddDebtDistributor') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">
                <h4>إضافة دين لموزع</h4>
            </a>
        </div>
    </nav>
    <!-- Navbar End -->
                            ...
                            <div class="modal fade" id="staticBackdrop{{ $item->id }}n" data-bs-backdrop="static"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('updateDebtDistributor') }}">
                                            @csrf


                                            <input type="text" name="distributor_id" value="{{ $item->distributor->id }}"
                                                hidden>
